export const site = {
  ...
  "templateName": "FeaturePriority Matrix",
  "slug": "11-featurepriority-matrix",
  "tagline": "FeaturePriority Matrix is a sellable Roadmap & Feature Request Platforms template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "FeaturePriority Matrix record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "66%"
    },
    {
      "id": "R-002",
      "name": "FeaturePriority Matrix record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "78%"
    },
    {
      "id": "R-003",
      "name": "FeaturePriority Matrix record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "90%"
    },
    {
      "id": "R-004",
      "name": "FeaturePriority Matrix record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "102%"
    },
    {
      "id": "R-005",
      "name": "FeaturePriority Matrix record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "114%"
    },
    {
      "id": "R-006",
      "name": "FeaturePriority Matrix record 6",
      "owner": "QA",
      "status": "Review",
      "value": "126%"
    }
