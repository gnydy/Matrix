export const site = {
  ...
  "templateName": "EnterpriseRoadmap View",
  "slug": "16-enterpriseroadmap-view",
  "tagline": "EnterpriseRoadmap View is a sellable Roadmap & Feature Request Platforms template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "EnterpriseRoadmap View record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "66%"
    },
    {
      "id": "R-002",
      "name": "EnterpriseRoadmap View record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "78%"
    },
    {
      "id": "R-003",
      "name": "EnterpriseRoadmap View record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "90%"
    },
    {
      "id": "R-004",
      "name": "EnterpriseRoadmap View record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "102%"
    },
    {
      "id": "R-005",
      "name": "EnterpriseRoadmap View record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "114%"
    },
    {
      "id": "R-006",
      "name": "EnterpriseRoadmap View record 6",
      "owner": "QA",
      "status": "Review",
      "value": "126%"
    }
