...
export default function ReportsControl() {
  return (
    <AdminShell title="Reports" eyebrow="Report generation, export-ready sections and evidence views.">
      <div className="grid gap-6 lg:grid-cols-[.85fr_1.15fr]">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5">
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-[var(--accent)]">Reports</p>
