# Restaurant Ops Admin

A restaurant operations admin panel for kitchen order flow, menu control, table bookings, delivery tracking and staff shift visibility.

## Commercial Use Case
Manage orders, menu, reservations, kitchen queue, delivery status and staff shifts

## Target Client
Restaurants, cloud kitchens and delivery kitchens

## Category
Dashboard & Admin Panels / Restaurant
