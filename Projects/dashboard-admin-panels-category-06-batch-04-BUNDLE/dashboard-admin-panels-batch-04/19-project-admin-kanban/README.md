# Project Admin Kanban

A project operations dashboard combining Kanban, milestones, task health, team load, delivery risks, and client reporting.

## Commercial Use Case
Manage tasks, projects, timelines, teams, milestones, risks and client reports

## Target Client
Agencies, software teams and PM offices

## Category
Dashboard & Admin Panels / Project Management
