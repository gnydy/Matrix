...
export default function AnalyticsControl() {
  return (
    <AdminShell title="Analytics" eyebrow="Decision dashboards, trend panels and metric drill-downs.">
      <div className="grid gap-6 lg:grid-cols-[.85fr_1.15fr]">
        <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5">
          <p className="text-sm font-bold uppercase tracking-[0.2em] text-[var(--accent)]">Analytics</p>
