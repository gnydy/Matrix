# Manufacturing Floor Admin

A production-grade admin interface for factories that need a digital view of machines, work orders, quality, and materials.

## Commercial Use Case
Manage work orders, machines, material usage, quality checks and downtime

## Target Client
Factories and production managers

## Category
Dashboard & Admin Panels / Manufacturing
