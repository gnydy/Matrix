export const site = {
  ...
  "templateName": "LineOps MES",
  "slug": "01-lineops-mes",
  "tagline": "LineOps MES is a sellable Manufacturing Systems template with realistic modules and backend mock routes.",
