export const site = {
  ...
  "templateName": "EcommerceTheme Store",
  "slug": "13-ecommercetheme-store",
  "tagline": "EcommerceTheme Store is a sellable Template Marketplaces template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "EcommerceTheme Store record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "67%"
    },
    {
      "id": "R-002",
      "name": "EcommerceTheme Store record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "79%"
    },
    {
      "id": "R-003",
      "name": "EcommerceTheme Store record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "91%"
    },
    {
      "id": "R-004",
      "name": "EcommerceTheme Store record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "103%"
    },
    {
      "id": "R-005",
      "name": "EcommerceTheme Store record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "115%"
    },
    {
      "id": "R-006",
      "name": "EcommerceTheme Store record 6",
      "owner": "QA",
      "status": "Review",
      "value": "127%"
    }
