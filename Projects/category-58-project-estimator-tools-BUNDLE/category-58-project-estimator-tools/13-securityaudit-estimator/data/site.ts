export const site = {
  ...
  "templateName": "SecurityAudit Estimator",
  "slug": "13-securityaudit-estimator",
  "tagline": "SecurityAudit Estimator is a sellable Project Estimator Tools template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "SecurityAudit Estimator record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "70%"
    },
    {
      "id": "R-002",
      "name": "SecurityAudit Estimator record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "82%"
    },
    {
      "id": "R-003",
      "name": "SecurityAudit Estimator record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "94%"
    },
    {
      "id": "R-004",
      "name": "SecurityAudit Estimator record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "106%"
    },
    {
      "id": "R-005",
      "name": "SecurityAudit Estimator record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "118%"
    },
    {
      "id": "R-006",
      "name": "SecurityAudit Estimator record 6",
      "owner": "QA",
      "status": "Review",
      "value": "130%"
    }
