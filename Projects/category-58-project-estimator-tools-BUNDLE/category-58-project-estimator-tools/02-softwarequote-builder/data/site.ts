export const site = {
  ...
  "templateName": "SoftwareQuote Builder",
  "slug": "02-softwarequote-builder",
  "tagline": "SoftwareQuote Builder is a sellable Project Estimator Tools template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "SoftwareQuote Builder record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "70%"
    },
    {
      "id": "R-002",
      "name": "SoftwareQuote Builder record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "82%"
    },
    {
      "id": "R-003",
      "name": "SoftwareQuote Builder record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "94%"
    },
    {
      "id": "R-004",
      "name": "SoftwareQuote Builder record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "106%"
    },
    {
      "id": "R-005",
      "name": "SoftwareQuote Builder record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "118%"
    },
    {
      "id": "R-006",
      "name": "SoftwareQuote Builder record 6",
      "owner": "QA",
      "status": "Review",
      "value": "130%"
    }
