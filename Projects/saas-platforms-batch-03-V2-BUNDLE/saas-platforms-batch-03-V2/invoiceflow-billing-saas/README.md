# InvoiceFlow Billing Suite

Subscription billing that feels like a disciplined finance desk, not a spreadsheet.

## Commercial positioning
- **Template type:** SaaS Platform Template
- **Concept:** Billing and subscription ledger
- **Target client:** Subscription startups, agencies, and finance departments
- **Use case:** Manage invoices, subscriptions, taxes, and collection reminders
- **Port:** http://localhost:3042
