# MetricForge Analytics Cloud

Live intelligence boards for teams that need clean numbers before decisions.

## Commercial positioning
- **Template type:** SaaS Platform Template
- **Concept:** Executive analytics cockpit
- **Target client:** Founders, CFOs, growth teams, and SaaS operators
- **Use case:** Track revenue, cohorts, funnels, and operational KPIs
- **Port:** http://localhost:3041
