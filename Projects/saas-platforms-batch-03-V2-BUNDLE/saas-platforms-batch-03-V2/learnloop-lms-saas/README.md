...
A learning SaaS that makes progress, content, and revenue visible in one place.

## Commercial positioning
- **Template type:** SaaS Platform Template
- **Concept:** Learning platform and student progress hub
- **Target client:** Academies, coaches, schools, and corporate training teams
- **Use case:** Sell courses, track progress, and manage instructors
- **Port:** http://localhost:3045
