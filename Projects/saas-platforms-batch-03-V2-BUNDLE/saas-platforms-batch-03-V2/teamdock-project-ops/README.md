# TeamDock Project Ops

Project delivery without scattered boards, lost files, or invisible blockers.

## Commercial positioning
- **Template type:** SaaS Platform Template
- **Concept:** Project execution and team delivery SaaS
- **Target client:** Agencies, software teams, consulting firms, and operations teams
- **Use case:** Plan sprints, manage tasks, track resources, and report delivery health
- **Port:** http://localhost:3055
