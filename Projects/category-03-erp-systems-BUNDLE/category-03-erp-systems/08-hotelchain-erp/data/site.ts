export const site = {
  ...
  "templateName": "HotelChain ERP",
  "slug": "08-hotelchain-erp",
  "tagline": "HotelChain ERP is a sellable ERP Systems template with realistic modules and backend mock routes.",
