...
export default function Page() {
  ...
  return <main><Navigation /><section className="bg-slate-950 px-5 py-16"><div className="mx-auto max-w-7xl"><p className="text-sm font-bold uppercase tracking-[0.25em] text-slate-500">Pricing architecture</p><h1 className="mt-4 max-w-4xl text-5xl font-black text-white">Subscription plans with commercial positioning.</h1><p className="mt-5 max-w-3xl text-lg leading-8 text-slate-400">Pricing is structured to make the template easy to sell, customize, and scale into a real SaaS product.</p></div></section>{map['pricing']}<Workflow /><Footer /></main>;
}
