...
export default function Page() {
  ...
  return <main><Navigation /><section className="bg-slate-950 px-5 py-16"><div className="mx-auto max-w-7xl"><p className="text-sm font-bold uppercase tracking-[0.25em] text-slate-500">Documentation center</p><h1 className="mt-4 max-w-4xl text-5xl font-black text-white">Client-ready documentation blocks.</h1><p className="mt-5 max-w-3xl text-lg leading-8 text-slate-400">Docs pages help the template look like a real SaaS product with installation, customization, and delivery guidance.</p></div></section>{map['docs']}<Workflow /><Footer /></main>;
}
