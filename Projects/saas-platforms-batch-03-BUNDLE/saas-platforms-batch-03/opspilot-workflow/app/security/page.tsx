...
export default function Page() {
  ...
  return <main><Navigation /><section className="bg-slate-950 px-5 py-16"><div className="mx-auto max-w-7xl"><p className="text-sm font-bold uppercase tracking-[0.25em] text-slate-500">Security posture</p><h1 className="mt-4 max-w-4xl text-5xl font-black text-white">Trust sections suitable for enterprise SaaS sales.</h1><p className="mt-5 max-w-3xl text-lg leading-8 text-slate-400">Security here is frontend messaging and UX structure. Real security must be implemented server-side during production development.</p></div></section>{map['security']}<Workflow /><Footer /></main>;
}
