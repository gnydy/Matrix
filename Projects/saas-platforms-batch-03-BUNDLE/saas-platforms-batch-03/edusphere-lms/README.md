...
## وصف القالب
Course catalog, student dashboard, lesson progress, certificates, and instructor analytics.
...
## Target Client
Academies, tutors, training companies

## Visual Identity
- Layout: Learning journey hero with student progress ring
- Tone: premium academy LMS
- Complexity: Advanced
- Suggested price range: $99-$279
