...
export default function Page() {
  ...
  return <main><Navigation /><section className="bg-slate-950 px-5 py-16"><div className="mx-auto max-w-7xl"><p className="text-sm font-bold uppercase tracking-[0.25em] text-slate-500">Dashboard preview</p><h1 className="mt-4 max-w-4xl text-5xl font-black text-white">A realistic control room for the SaaS buyer.</h1><p className="mt-5 max-w-3xl text-lg leading-8 text-slate-400">This page gives the client a clear feeling of a real operational system with tables, activities, stats, and role-based UI concepts.</p></div></section>{map['dashboard']}<Workflow /><Footer /></main>;
}
