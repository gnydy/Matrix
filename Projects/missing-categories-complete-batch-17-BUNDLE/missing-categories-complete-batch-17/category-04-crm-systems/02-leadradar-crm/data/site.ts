export const site = {
  ...
  "templateName": "LeadRadar CRM",
  "slug": "02-leadradar-crm",
  "tagline": "LeadRadar CRM is a sellable CRM Systems template with realistic modules and backend mock routes.",
