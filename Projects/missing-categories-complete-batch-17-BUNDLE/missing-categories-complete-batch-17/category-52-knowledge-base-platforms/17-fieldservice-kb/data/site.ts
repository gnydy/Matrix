export const site = {
  ...
  "templateName": "FieldService KB",
  "slug": "17-fieldservice-kb",
  "tagline": "FieldService KB is a sellable Knowledge Base Platforms template with realistic modules and backend mock routes.",
