export const site = {
  ...
  "templateName": "HelpNest KB",
  "slug": "01-helpnest-kb",
  "tagline": "HelpNest KB is a sellable Knowledge Base Platforms template with realistic modules and backend mock routes.",
