export const site = {
  ...
  "templateName": "BeautySalon OS",
  "slug": "16-beautysalon-os",
  "tagline": "BeautySalon OS is a sellable Industry-Specific Solutions template with realistic modules and backend mock routes.",
