export const site = {
  ...
  "templateName": "QualityGate QC",
  "slug": "04-qualitygate-qc",
  "tagline": "QualityGate QC is a sellable Manufacturing Systems template with realistic modules and backend mock routes.",
