export const site = {
  ...
  "templateName": "ChemicalProcess Board",
  "slug": "18-chemicalprocess-board",
  "tagline": "ChemicalProcess Board is a sellable Manufacturing Systems template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "ChemicalProcess Board record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "28%"
    },
    {
      "id": "R-002",
      "name": "ChemicalProcess Board record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "40%"
    },
    {
      "id": "R-003",
      "name": "ChemicalProcess Board record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "52%"
    },
    {
      "id": "R-004",
      "name": "ChemicalProcess Board record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "64%"
    },
    {
      "id": "R-005",
      "name": "ChemicalProcess Board record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "76%"
    },
    {
      "id": "R-006",
      "name": "ChemicalProcess Board record 6",
      "owner": "QA",
      "status": "Review",
      "value": "88%"
    }
