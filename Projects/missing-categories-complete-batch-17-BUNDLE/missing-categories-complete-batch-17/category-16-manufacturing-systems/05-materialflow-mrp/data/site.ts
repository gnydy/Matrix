export const site = {
  ...
  "templateName": "MaterialFlow MRP",
  "slug": "05-materialflow-mrp",
  "tagline": "MaterialFlow MRP is a sellable Manufacturing Systems template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "MaterialFlow MRP record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "28%"
    },
    {
      "id": "R-002",
      "name": "MaterialFlow MRP record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "40%"
    },
    {
      "id": "R-003",
      "name": "MaterialFlow MRP record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "52%"
    },
    {
      "id": "R-004",
      "name": "MaterialFlow MRP record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "64%"
    },
    {
      "id": "R-005",
      "name": "MaterialFlow MRP record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "76%"
    },
    {
      "id": "R-006",
      "name": "MaterialFlow MRP record 6",
      "owner": "QA",
      "status": "Review",
      "value": "88%"
    }
