# ConcertFestival Site

Category: 40 - Event & Conference Websites

## Description
Speakers, agenda, tickets, sponsors, venues, and registration. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
