# RegistrationPro Event

Category: 40 - Event & Conference Websites

## Description
Speakers, agenda, tickets, sponsors, venues, and registration. This template uses a distinct UI pattern: AI assistant workspace with prompt panel and result board.
