...
## Description
Speakers, agenda, tickets, sponsors, venues, and registration. This template uses a distinct UI pattern: marketing website with editorial hero and case-study grid.
