# StartupDemoDay Event

Category: 40 - Event & Conference Websites

## Description
Speakers, agenda, tickets, sponsors, venues, and registration. This template uses a distinct UI pattern: split command layout with sticky right insight panel.
