...
## Description
Speakers, agenda, tickets, sponsors, venues, and registration. This template uses a distinct UI pattern: desktop app shell with toolbar, tabs, and resizable panels.
