$root = "/mnt/data/categories-26-to-50-batch-16/category-40-event-conference-websites"
...
Write-Host "Started category 40 from 3001 to 3020" -ForegroundColor Green
