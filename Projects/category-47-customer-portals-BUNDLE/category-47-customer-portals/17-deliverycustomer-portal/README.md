# DeliveryCustomer Portal

Category: 47 - Customer Portals

## Description
Tickets, invoices, files, orders, project status, account settings. This template uses a distinct UI pattern: dark operations cockpit with alert stream.
