# ProjectStatus Client Area

Category: 47 - Customer Portals

## Description
Tickets, invoices, files, orders, project status, account settings. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
