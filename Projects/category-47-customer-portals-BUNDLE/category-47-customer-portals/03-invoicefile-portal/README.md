...
## Description
Tickets, invoices, files, orders, project status, account settings. This template uses a distinct UI pattern: marketing website with editorial hero and case-study grid.
