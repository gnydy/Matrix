# MaintenanceClient Portal

Category: 47 - Customer Portals

## Description
Tickets, invoices, files, orders, project status, account settings. This template uses a distinct UI pattern: split command layout with sticky right insight panel.
