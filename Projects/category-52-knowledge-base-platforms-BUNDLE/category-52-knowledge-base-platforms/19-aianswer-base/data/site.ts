export const site = {
  ...
  "templateName": "AIAnswer Base",
  "slug": "19-aianswer-base",
  "tagline": "AIAnswer Base is a sellable Knowledge Base Platforms template with realistic modules and backend mock routes.",
