export const site = {
  ...
  "templateName": "LegalKnowledge Vault",
  "slug": "14-legalknowledge-vault",
  "tagline": "LegalKnowledge Vault is a sellable Knowledge Base Platforms template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "LegalKnowledge Vault record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "64%"
    },
    {
      "id": "R-002",
      "name": "LegalKnowledge Vault record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "76%"
    },
    {
      "id": "R-003",
      "name": "LegalKnowledge Vault record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "88%"
    },
    {
      "id": "R-004",
      "name": "LegalKnowledge Vault record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "100%"
    },
    {
      "id": "R-005",
      "name": "LegalKnowledge Vault record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "112%"
    },
    {
      "id": "R-006",
      "name": "LegalKnowledge Vault record 6",
      "owner": "QA",
      "status": "Review",
      "value": "124%"
    }
