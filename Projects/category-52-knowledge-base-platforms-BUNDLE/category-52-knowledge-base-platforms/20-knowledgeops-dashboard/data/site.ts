export const site = {
  ...
  "templateName": "KnowledgeOps Dashboard",
  "slug": "20-knowledgeops-dashboard",
  "tagline": "KnowledgeOps Dashboard is a sellable Knowledge Base Platforms template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "KnowledgeOps Dashboard record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "64%"
    },
    {
      "id": "R-002",
      "name": "KnowledgeOps Dashboard record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "76%"
    },
    {
      "id": "R-003",
      "name": "KnowledgeOps Dashboard record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "88%"
    },
    {
      "id": "R-004",
      "name": "KnowledgeOps Dashboard record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "100%"
    },
    {
      "id": "R-005",
      "name": "KnowledgeOps Dashboard record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "112%"
    },
    {
      "id": "R-006",
      "name": "KnowledgeOps Dashboard record 6",
      "owner": "QA",
      "status": "Review",
      "value": "124%"
    }
