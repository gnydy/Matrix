# UrbanNest Rentals Platform

Fast rental search platform for apartments, studios, and managed rentals.

## Use Case
Help tenants filter rental units and request viewings quickly.

## Target Client
Rental marketplaces and property management startups
