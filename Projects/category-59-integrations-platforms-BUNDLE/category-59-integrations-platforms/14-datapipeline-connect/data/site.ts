export const site = {
  ...
  "templateName": "DataPipeline Connect",
  "slug": "14-datapipeline-connect",
  "tagline": "DataPipeline Connect is a sellable Integrations Platforms template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "DataPipeline Connect record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "71%"
    },
    {
      "id": "R-002",
      "name": "DataPipeline Connect record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "83%"
    },
    {
      "id": "R-003",
      "name": "DataPipeline Connect record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "95%"
    },
    {
      "id": "R-004",
      "name": "DataPipeline Connect record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "107%"
    },
    {
      "id": "R-005",
      "name": "DataPipeline Connect record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "119%"
    },
    {
      "id": "R-006",
      "name": "DataPipeline Connect record 6",
      "owner": "QA",
      "status": "Review",
      "value": "131%"
    }
