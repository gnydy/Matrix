# CourseMembership Hub

Category: 45 - Membership Platforms

## Description
Plans, member areas, premium content, subscriptions, and community access. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
