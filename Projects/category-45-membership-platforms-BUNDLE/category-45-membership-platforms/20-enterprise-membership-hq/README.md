# Enterprise Membership HQ

Category: 45 - Membership Platforms

## Description
Plans, member areas, premium content, subscriptions, and community access. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
