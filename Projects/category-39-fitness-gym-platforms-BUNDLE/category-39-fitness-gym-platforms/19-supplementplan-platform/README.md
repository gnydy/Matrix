# SupplementPlan Platform

Category: 39 - Fitness & Gym Platforms

## Description
Memberships, trainers, classes, bookings, nutrition, and progress dashboards. This template uses a distinct UI pattern: data room layout with document table and activity feed.
