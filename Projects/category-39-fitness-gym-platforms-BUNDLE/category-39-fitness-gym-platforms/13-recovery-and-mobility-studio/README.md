# Recovery & Mobility Studio

Category: 39 - Fitness & Gym Platforms

## Description
Memberships, trainers, classes, bookings, nutrition, and progress dashboards. This template uses a distinct UI pattern: dark operations cockpit with alert stream.
