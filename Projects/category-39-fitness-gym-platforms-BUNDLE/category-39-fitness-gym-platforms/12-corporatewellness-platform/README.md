# CorporateWellness Platform

Category: 39 - Fitness & Gym Platforms

## Description
Memberships, trainers, classes, bookings, nutrition, and progress dashboards. This template uses a distinct UI pattern: card-based workspace with filter bar and live status rail.
