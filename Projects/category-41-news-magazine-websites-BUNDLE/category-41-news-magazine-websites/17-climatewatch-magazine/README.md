...
## Description
Articles, categories, authors, trending content, newsletters, and ads layouts. This template uses a distinct UI pattern: data room layout with document table and activity feed.
