...
## Description
Articles, categories, authors, trending content, newsletters, and ads layouts. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
