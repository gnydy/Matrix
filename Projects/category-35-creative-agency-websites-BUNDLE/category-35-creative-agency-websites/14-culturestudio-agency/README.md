# CultureStudio Agency

Category: 35 - Creative Agency Websites

## Description
Branding studios, portfolios, motion work, visual case studies, and pitch pages. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
