# Enterprise Creative HQ

Category: 35 - Creative Agency Websites

## Description
Branding studios, portfolios, motion work, visual case studies, and pitch pages. This template uses a distinct UI pattern: dashboard marketplace grid with comparison cards.
