# FestivalCreative Studio

Category: 35 - Creative Agency Websites

## Description
Branding studios, portfolios, motion work, visual case studies, and pitch pages. This template uses a distinct UI pattern: dark operations cockpit with alert stream.
