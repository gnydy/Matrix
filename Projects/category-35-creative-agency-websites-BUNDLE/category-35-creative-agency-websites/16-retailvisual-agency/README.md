...
## Description
Branding studios, portfolios, motion work, visual case studies, and pitch pages. This template uses a distinct UI pattern: card-based workspace with filter bar and live status rail.
