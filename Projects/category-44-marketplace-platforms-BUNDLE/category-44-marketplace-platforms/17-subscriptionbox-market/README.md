# SubscriptionBox Market

Category: 44 - Marketplace Platforms

## Description
Vendor listings, products, services, orders, reviews, seller/buyer dashboards. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
