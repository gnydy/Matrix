# ServiceBazaar Marketplace

Category: 44 - Marketplace Platforms

## Description
Vendor listings, products, services, orders, reviews, seller/buyer dashboards. This template uses a distinct UI pattern: data room layout with document table and activity feed.
