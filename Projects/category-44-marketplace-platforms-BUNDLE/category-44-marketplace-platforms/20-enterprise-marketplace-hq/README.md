# Enterprise Marketplace HQ

Category: 44 - Marketplace Platforms

## Description
Vendor listings, products, services, orders, reviews, seller/buyer dashboards. This template uses a distinct UI pattern: dark operations cockpit with alert stream.
