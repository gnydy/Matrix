export const crm = {
  ...
  positioning: "Admissions CRM",
  target: "Schools, academies, and universities managing student applications",
  concept: "Student admissions CRM with inquiry stages, document checklist, interviews, and enrollment forecast",
  variant: "admissions-funnel",
  port: 3089,
  modules: [
  {
    "name": "Leads",
  ...
  activity: [
  "Admissions CRM priority account moved to proposal",
