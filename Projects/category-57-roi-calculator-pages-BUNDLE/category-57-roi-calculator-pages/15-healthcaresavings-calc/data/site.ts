export const site = {
  ...
  "templateName": "HealthcareSavings Calc",
  "slug": "15-healthcaresavings-calc",
  "tagline": "HealthcareSavings Calc is a sellable ROI Calculator Pages template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "HealthcareSavings Calc record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "69%"
    },
    {
      "id": "R-002",
      "name": "HealthcareSavings Calc record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "81%"
    },
    {
      "id": "R-003",
      "name": "HealthcareSavings Calc record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "93%"
    },
    {
      "id": "R-004",
      "name": "HealthcareSavings Calc record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "105%"
    },
    {
      "id": "R-005",
      "name": "HealthcareSavings Calc record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "117%"
    },
    {
      "id": "R-006",
      "name": "HealthcareSavings Calc record 6",
      "owner": "QA",
      "status": "Review",
      "value": "129%"
    }
