export const site = {
  ...
  "templateName": "SandboxLaunch Portal",
  "slug": "02-sandboxlaunch-portal",
  "tagline": "SandboxLaunch Portal is a sellable Demo Centers & Live Sandbox template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "SandboxLaunch Portal record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "68%"
    },
    {
      "id": "R-002",
      "name": "SandboxLaunch Portal record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "80%"
    },
    {
      "id": "R-003",
      "name": "SandboxLaunch Portal record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "92%"
    },
    {
      "id": "R-004",
      "name": "SandboxLaunch Portal record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "104%"
    },
    {
      "id": "R-005",
      "name": "SandboxLaunch Portal record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "116%"
    },
    {
      "id": "R-006",
      "name": "SandboxLaunch Portal record 6",
      "owner": "QA",
      "status": "Review",
      "value": "128%"
    }
