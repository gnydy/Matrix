export const site = {
  ...
  "templateName": "ClientDemo Board",
  "slug": "06-clientdemo-board",
  "tagline": "ClientDemo Board is a sellable Demo Centers & Live Sandbox template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "ClientDemo Board record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "68%"
    },
    {
      "id": "R-002",
      "name": "ClientDemo Board record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "80%"
    },
    {
      "id": "R-003",
      "name": "ClientDemo Board record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "92%"
    },
    {
      "id": "R-004",
      "name": "ClientDemo Board record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "104%"
    },
    {
      "id": "R-005",
      "name": "ClientDemo Board record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "116%"
    },
    {
      "id": "R-006",
      "name": "ClientDemo Board record 6",
      "owner": "QA",
      "status": "Review",
      "value": "128%"
    }
