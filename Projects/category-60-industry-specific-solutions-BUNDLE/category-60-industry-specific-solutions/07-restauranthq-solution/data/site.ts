export const site = {
  ...
  "templateName": "RestaurantHQ Solution",
  "slug": "07-restauranthq-solution",
  "tagline": "RestaurantHQ Solution is a sellable Industry-Specific Solutions template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "RestaurantHQ Solution record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "72%"
    },
    {
      "id": "R-002",
      "name": "RestaurantHQ Solution record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "84%"
    },
    {
      "id": "R-003",
      "name": "RestaurantHQ Solution record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "96%"
    },
    {
      "id": "R-004",
      "name": "RestaurantHQ Solution record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "108%"
    },
    {
      "id": "R-005",
      "name": "RestaurantHQ Solution record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "120%"
    },
    {
      "id": "R-006",
      "name": "RestaurantHQ Solution record 6",
      "owner": "QA",
      "status": "Review",
      "value": "132%"
    }
