export const site = {
  name: "NomadPass Adventure Tours",
  slug: "nomadpass-adventure-tours",
  logo: "NA",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#F97316",
  soft: "#FFF7ED",
  hero: "NomadPass Adventure Tours built for booking, guest experience, and travel operations.",
  description: "Adventure travel booking site for expeditions, hiking, diving, and guided tours.",
  longDescription: "Adventure travel booking site for expeditions, hiking, diving, and guided tours. Designed for adventure tour companies with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Expedition packages, risk notes, booking slots, itinerary tracker",
  defaultDestination: "NomadPass flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Bold outdoor visual system with activity-focused sections", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
