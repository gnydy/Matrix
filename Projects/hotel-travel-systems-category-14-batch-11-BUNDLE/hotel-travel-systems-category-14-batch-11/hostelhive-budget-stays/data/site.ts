export const site = {
  name: "HostelHive Budget Stays",
  slug: "hostelhive-budget-stays",
  logo: "HB",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#84CC16",
  soft: "#ECFCCB",
  hero: "HostelHive Budget Stays built for booking, guest experience, and travel operations.",
  description: "Hostel and budget accommodation booking frontend with shared rooms and community.",
  longDescription: "Hostel and budget accommodation booking frontend with shared rooms and community. Designed for hostel chains and budget travel platforms with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Dorm listings, beds, traveler reviews, booking, guest hub",
  defaultDestination: "HostelHive flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Community-first youth travel design with energetic cards", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
