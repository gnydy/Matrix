# MedinaHajj Pilgrimage Planner

## Commercial Description
Pilgrimage travel planner for groups, hotels, transfers, and guided schedules.

## Use Case
Group packages, itinerary, rooming list mock, operations dashboard

## Target Client
Hajj/Umrah agencies and religious travel operators
...
## Run
```powershell
cd "medinahajj-pilgrimage-planner"
.\run.ps1
```
