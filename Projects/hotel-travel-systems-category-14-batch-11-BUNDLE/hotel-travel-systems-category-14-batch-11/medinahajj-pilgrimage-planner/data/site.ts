export const site = {
  name: "MedinaHajj Pilgrimage Planner",
  slug: "medinahajj-pilgrimage-planner",
  logo: "MP",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#14B8A6",
  soft: "#CCFBF1",
  hero: "MedinaHajj Pilgrimage Planner built for booking, guest experience, and travel operations.",
  description: "Pilgrimage travel planner for groups, hotels, transfers, and guided schedules.",
  longDescription: "Pilgrimage travel planner for groups, hotels, transfers, and guided schedules. Designed for hajj/umrah agencies and religious travel operators with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Group packages, itinerary, rooming list mock, operations dashboard",
  defaultDestination: "MedinaHajj flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Calm trust-first UI with schedule, group, and compliance-style panels", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
