export const site = {
  name: "CoastalVilla Rental Portal",
  slug: "coastalvilla-rental-portal",
  logo: "CR",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#06B6D4",
  soft: "#CFFAFE",
  hero: "CoastalVilla Rental Portal built for booking, guest experience, and travel operations.",
  description: "Vacation villa booking platform with availability, amenities, and owner dashboard.",
  longDescription: "Vacation villa booking platform with availability, amenities, and owner dashboard. Designed for villa rental companies and property managers with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Villa listings, availability, booking, guest account, owner dashboard",
  defaultDestination: "CoastalVilla flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Real-estate-meets-hospitality layout with premium gallery blocks", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
