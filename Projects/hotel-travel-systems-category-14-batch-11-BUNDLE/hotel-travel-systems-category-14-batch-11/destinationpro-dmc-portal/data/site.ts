export const site = {
  name: "DestinationPro DMC Portal",
  slug: "destinationpro-dmc-portal",
  logo: "DD",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#0891B2",
  soft: "#CFFAFE",
  hero: "DestinationPro DMC Portal built for booking, guest experience, and travel operations.",
  description: "Destination management portal for agencies handling trips, vendors, and itineraries.",
  longDescription: "Destination management portal for agencies handling trips, vendors, and itineraries. Designed for dmcs and inbound travel operators with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Vendor cards, itinerary management, bookings, client portal, ops dashboard",
  defaultDestination: "DestinationPro flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Professional B2B travel operations layout with vendor and trip panels", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
