export const site = {
  name: "BusinessStay Corporate Travel",
  slug: "businessstay-corporate-travel",
  logo: "BC",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#334155",
  soft: "#E2E8F0",
  hero: "BusinessStay Corporate Travel built for booking, guest experience, and travel operations.",
  description: "Corporate travel and hotel booking UI for companies and travel managers.",
  longDescription: "Corporate travel and hotel booking UI for companies and travel managers. Designed for corporate travel departments and b2b agencies with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Policy-aware booking, traveler profiles, approval dashboard, reports",
  defaultDestination: "BusinessStay flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Business admin UI fused with clean travel booking components", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
