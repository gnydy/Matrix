export const site = {
  name: "Aparthotel FlexStay",
  slug: "aparthotel-flexstay",
  logo: "AF",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#64748B",
  soft: "#F1F5F9",
  hero: "Aparthotel FlexStay built for booking, guest experience, and travel operations.",
  description: "Aparthotel booking frontend for short and long stays with flexible rates.",
  longDescription: "Aparthotel booking frontend for short and long stays with flexible rates. Designed for aparthotels and serviced residence operators with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Long-stay plans, room types, rates, booking, resident portal",
  defaultDestination: "Aparthotel flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Clean residence-style UI with stay-duration pricing logic", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
