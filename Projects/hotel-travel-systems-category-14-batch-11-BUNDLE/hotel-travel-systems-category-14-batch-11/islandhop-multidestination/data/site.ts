export const site = {
  name: "IslandHop MultiDestination",
  slug: "islandhop-multidestination",
  logo: "IM",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#0284C7",
  soft: "#E0F2FE",
  hero: "IslandHop MultiDestination built for booking, guest experience, and travel operations.",
  description: "Multi-destination island hopping planner and booking frontend.",
  longDescription: "Multi-destination island hopping planner and booking frontend. Designed for island resorts and multi-city tour companies with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Multi-stop itinerary, transport legs, hotel nights, booking summary",
  defaultDestination: "IslandHop flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Interactive itinerary-style UI with connected destination cards", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
