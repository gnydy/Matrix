export const site = {
  name: "SafariBase Expedition Travel",
  slug: "safaribase-expedition-travel",
  logo: "SE",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#A16207",
  soft: "#FEF3C7",
  hero: "SafariBase Expedition Travel built for booking, guest experience, and travel operations.",
  description: "Safari and expedition travel platform for camps, guides, and luxury trips.",
  longDescription: "Safari and expedition travel platform for camps, guides, and luxury trips. Designed for safari operators and destination management companies with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Camp packages, guide profiles, availability, itinerary, booking request",
  defaultDestination: "SafariBase flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Earth-tone editorial system with itinerary map-style sections", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
