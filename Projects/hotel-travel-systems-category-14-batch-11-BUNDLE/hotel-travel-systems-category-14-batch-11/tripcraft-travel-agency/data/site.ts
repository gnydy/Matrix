export const site = {
  name: "TripCraft Travel Agency",
  slug: "tripcraft-travel-agency",
  logo: "TT",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#0EA5E9",
  soft: "#E0F2FE",
  hero: "TripCraft Travel Agency built for booking, guest experience, and travel operations.",
  description: "Modern travel agency system for selling curated trips, tours, and itineraries.",
  longDescription: "Modern travel agency system for selling curated trips, tours, and itineraries. Designed for travel agencies and tour operators with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Tour packages, itinerary builder, inquiry booking, consultant dashboard",
  defaultDestination: "TripCraft flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Magazine-style travel layout with destination cards and advisor-led CTAs", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
