export const site = {
  name: "TravelOps Control Tower",
  slug: "travelops-control-tower",
  logo: "TC",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#0F172A",
  soft: "#E2E8F0",
  hero: "TravelOps Control Tower built for booking, guest experience, and travel operations.",
  description: "Travel operations dashboard for agencies managing bookings, guests, vendors, and issues.",
  longDescription: "Travel operations dashboard for agencies managing bookings, guests, vendors, and issues. Designed for large travel agencies and operations teams with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Ops dashboard, bookings, vendors, issues, traveler notifications",
  defaultDestination: "TravelOps flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Control-tower admin interface with operational KPIs and queue systems", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
