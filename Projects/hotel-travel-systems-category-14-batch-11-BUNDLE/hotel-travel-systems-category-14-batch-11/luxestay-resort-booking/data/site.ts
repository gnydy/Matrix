export const site = {
  ...
  accent: "#D8B45B",
  soft: "#FFF7E0",
  hero: "LuxeStay Resort Booking built for booking, guest experience, and travel operations.",
  description: "Luxury resort booking platform for premium hotels and beachfront resorts.",
  longDescription: "Luxury resort booking platform for premium hotels and beachfront resorts. Designed for five-star resorts and luxury hotel chains with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Resort rooms, spa packages, VIP guest portal, revenue dashboard",
  defaultDestination: "LuxeStay flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Gold-accented editorial luxury interface with immersive hero cards", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
