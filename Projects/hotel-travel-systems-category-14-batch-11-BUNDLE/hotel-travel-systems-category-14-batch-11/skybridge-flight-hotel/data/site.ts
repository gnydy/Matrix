export const site = {
  name: "SkyBridge Flight & Hotel",
  slug: "skybridge-flight-hotel",
  logo: "SF",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#2563EB",
  soft: "#DBEAFE",
  hero: "SkyBridge Flight & Hotel built for booking, guest experience, and travel operations.",
  description: "Flight-and-hotel package booking frontend for bundled travel offers.",
  longDescription: "Flight-and-hotel package booking frontend for bundled travel offers. Designed for online travel agencies and package sellers with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Bundles, flight/hotel cards, booking checkout mock, trip dashboard",
  defaultDestination: "SkyBridge flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Travel search layout with comparison cards and package economics", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
