export const site = {
  name: "EcoTrail Sustainable Travel",
  slug: "ecotrail-sustainable-travel",
  logo: "ES",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#16A34A",
  soft: "#DCFCE7",
  hero: "EcoTrail Sustainable Travel built for booking, guest experience, and travel operations.",
  description: "Sustainable travel platform showing eco impact, packages, and responsible trips.",
  longDescription: "Sustainable travel platform showing eco impact, packages, and responsible trips. Designed for eco lodges and sustainable travel companies with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Eco packages, impact metrics, booking, guide notes, traveler portal",
  defaultDestination: "EcoTrail flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Impact-led green travel UI with metrics and responsible-tourism storytelling", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
