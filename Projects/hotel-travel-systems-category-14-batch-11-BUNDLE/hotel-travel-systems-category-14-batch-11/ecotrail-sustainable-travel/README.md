# EcoTrail Sustainable Travel

## Commercial Description
Sustainable travel platform showing eco impact, packages, and responsible trips.

## Use Case
Eco packages, impact metrics, booking, guide notes, traveler portal

## Target Client
Eco lodges and sustainable travel companies
...
## Run
```powershell
cd "ecotrail-sustainable-travel"
.\run.ps1
```
