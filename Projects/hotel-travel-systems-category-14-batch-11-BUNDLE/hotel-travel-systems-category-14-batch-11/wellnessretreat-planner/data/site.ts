export const site = {
  name: "WellnessRetreat Planner",
  slug: "wellnessretreat-planner",
  logo: "WP",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#22C55E",
  soft: "#DCFCE7",
  hero: "WellnessRetreat Planner built for booking, guest experience, and travel operations.",
  description: "Wellness retreat booking system for yoga, spa, detox, and health programs.",
  longDescription: "Wellness retreat booking system for yoga, spa, detox, and health programs. Designed for wellness resorts and retreat organizers with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Retreat programs, schedule, practitioner cards, guest portal",
  defaultDestination: "WellnessRetreat flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Soft premium wellness UI with schedule and transformation proof", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
