export const site = {
  name: "EventStay Group Blocks",
  slug: "eventstay-group-blocks",
  logo: "EG",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#7C3AED",
  soft: "#EDE9FE",
  hero: "EventStay Group Blocks built for booking, guest experience, and travel operations.",
  description: "Hotel room block and event stay management frontend.",
  longDescription: "Hotel room block and event stay management frontend. Designed for conference hotels, event planners, and venues with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Group room blocks, attendee booking, allocation dashboard, deadlines",
  defaultDestination: "EventStay flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Event operations UI with group allocation and timeline mechanics", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
