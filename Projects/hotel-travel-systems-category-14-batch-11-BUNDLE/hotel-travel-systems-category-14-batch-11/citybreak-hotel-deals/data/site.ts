export const site = {
  name: "CityBreak Hotel Deals",
  slug: "citybreak-hotel-deals",
  logo: "CH",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#EF4444",
  soft: "#FEE2E2",
  hero: "CityBreak Hotel Deals built for booking, guest experience, and travel operations.",
  description: "Urban hotel deals and weekend escape booking frontend.",
  longDescription: "Urban hotel deals and weekend escape booking frontend. Designed for city hotels and deal aggregators with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Deal cards, filters, last-minute offers, checkout mock, account page",
  defaultDestination: "CityBreak flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Fast conversion landing + catalog hybrid with deal urgency UI", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
