export const site = {
  name: "CruiseHarbor Booking",
  slug: "cruiseharbor-booking",
  logo: "CB",
  category: "Category 14 — Hotel & Travel Systems",
  tagline: "Hotel & Travel System Template",
  accent: "#0F766E",
  soft: "#CCFBF1",
  hero: "CruiseHarbor Booking built for booking, guest experience, and travel operations.",
  description: "Cruise package booking platform with cabins, routes, decks, and guest portal.",
  longDescription: "Cruise package booking platform with cabins, routes, decks, and guest portal. Designed for cruise companies and marine travel agencies with a professional UI that shows booking logic, availability, guest journeys, and operational control without requiring a backend.",
  positioning: "Cabin packages, route itinerary, passenger booking, cruise dashboard",
  defaultDestination: "CruiseHarbor flagship experience",
  ...
  features: [
    { kicker: "UX", title: "Nautical dashboard style with route timelines and cabin cards", text: "A distinct visual direction, navigation pattern, and content structure built for this specific travel business model." },
