# HealthyBowl Ordering

## Commercial description
Nutrition-first ordering UI with meal plans.

## Use case
Sell bowls, subscriptions, calories-based meals, and show nutrition dashboard for customers.

## Target client
Healthy food brands, salad bars, meal-prep restaurants.
