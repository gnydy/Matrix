export const site = {
  name: "BakeryDesk Artisan",
  segment: "Bakeries and patisseries",
  positioning: "Bakery ordering and production planning template",
  layout: "soft product gallery with production status panel",
  accent: "#be185d",
  dark: "#240817",
  light: "#fdf2f8",
  cta: "Pre-order bakery box",
  audience: "Bakeries, patisseries, cake shops, dessert brands",
  useCase: "Handle pre-orders, cake inquiries, daily bake schedule, and product catalog presentation.",
  tone: "artisan, soft, premium dessert",
  features: ["Pre-order boxes", "Cake inquiry form", "Bake schedule", "Pickup calendar"],
  metrics: ["86 pre-orders", "14 custom cakes", "42 fresh batches", "7 sold-out items"],
  modules: ["Product catalog", "Production board", "Custom cake leads", "Pickup slots"],
  menu: ["Sourdough loaf", "Berry tart", "Chocolate gateau", "Macaron gift box"],
  roles: ["Bakery owner", "Pastry chef", "Pickup manager"],
  nav: [
