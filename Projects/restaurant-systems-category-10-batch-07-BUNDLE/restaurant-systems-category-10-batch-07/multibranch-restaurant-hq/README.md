# MultiBranch Restaurant HQ

## Commercial description
Restaurant chain HQ website and admin dashboard template.

## Use case
Present brand, branches, menu, delivery channels, branch KPIs, and admin control room mock.

## Target client
Restaurant chains, franchise operators, multi-location food brands.
