...
Hotel dining and room-service control template.

## Use case
Manage room-service menu, restaurant reservation, guest profiles, kitchen queue, and delivery to rooms.

## Target client
Hotels, resorts, serviced apartments with dining operations.
