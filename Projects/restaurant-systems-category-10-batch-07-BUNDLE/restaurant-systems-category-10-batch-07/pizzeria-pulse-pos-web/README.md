# Pizzeria Pulse POS Web

## Commercial description
Pizza ordering storefront with operations dashboard.

## Use case
Sell custom pizzas with topping UI, delivery tracker, kitchen tickets, and branch performance cards.

## Target client
Pizza shops, casual restaurants, delivery restaurants.
