# CloudKitchen Command

## Commercial description
Multi-brand restaurant operating system UI.

## Use case
Control multiple delivery brands, menus, kitchens, orders, and performance from one operational UI.

## Target client
Cloud kitchens, dark kitchens, virtual restaurant operators.
