...
High-speed ordering system for delivery-first restaurants.

## Use case
Turn visitors into delivery orders with menu filters, combo cards, cart summary, and dispatch dashboard.

## Target client
Fast food chains, burger shops, fried chicken brands.
