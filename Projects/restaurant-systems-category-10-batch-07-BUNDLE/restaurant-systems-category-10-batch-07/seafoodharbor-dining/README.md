# SeafoodHarbor Dining

## Commercial description
Coastal seafood website with fresh-catch menu and table booking.

## Use case
Promote fresh catch, reservations, tasting platters, delivery seafood boxes, and chef prep dashboard.

## Target client
Seafood restaurants, coastal dining venues, fish markets with dine-in.
