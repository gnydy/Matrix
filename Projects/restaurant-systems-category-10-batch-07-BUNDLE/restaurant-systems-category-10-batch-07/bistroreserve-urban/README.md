...
Urban bistro website with booking and private dining funnel.

## Use case
Support table booking, event inquiries, seasonal menu presentation, and daily manager overview.

## Target client
Bistros, casual fine dining venues, neighborhood restaurants.
