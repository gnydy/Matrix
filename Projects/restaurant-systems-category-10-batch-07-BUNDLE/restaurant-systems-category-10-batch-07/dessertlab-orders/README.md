...
Dessert ecommerce-style restaurant template with operations panel.

## Use case
Sell dessert boxes, manage custom orders, display seasonal menu, and track prep/delivery states.

## Target client
Dessert bars, ice cream shops, waffle houses, sweet brands.
