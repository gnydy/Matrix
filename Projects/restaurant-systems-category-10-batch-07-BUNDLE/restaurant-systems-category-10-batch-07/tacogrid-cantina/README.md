...
Vibrant restaurant ordering and events template.

## Use case
Sell party boxes, table booking, happy-hour events, and manage kitchen/delivery status.

## Target client
Mexican restaurants, cantinas, casual food brands.
