# StreetFood Market OS

## Commercial description
Vendor-style street food marketplace UI.

## Use case
Display multiple vendors, menus, events, pickup zones, and market operations status.

## Target client
Food courts, pop-up markets, street food halls.
