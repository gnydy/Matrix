export const site = {
  ...
  "templateName": "ConnectorStatus Board",
  "slug": "18-connectorstatus-board",
  "tagline": "ConnectorStatus Board is a sellable Integrations Platforms template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "ConnectorStatus Board record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "71%"
    },
    {
      "id": "R-002",
      "name": "ConnectorStatus Board record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "83%"
    },
    {
      "id": "R-003",
      "name": "ConnectorStatus Board record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "95%"
    },
    {
      "id": "R-004",
      "name": "ConnectorStatus Board record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "107%"
    },
    {
      "id": "R-005",
      "name": "ConnectorStatus Board record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "119%"
    },
    {
      "id": "R-006",
      "name": "ConnectorStatus Board record 6",
      "owner": "QA",
      "status": "Review",
      "value": "131%"
    }
