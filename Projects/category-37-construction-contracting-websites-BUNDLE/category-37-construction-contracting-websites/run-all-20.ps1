$root = "/mnt/data/categories-26-to-50-batch-16/category-37-construction-contracting-websites"
...
Write-Host "Started category 37 from 3001 to 3020" -ForegroundColor Green
