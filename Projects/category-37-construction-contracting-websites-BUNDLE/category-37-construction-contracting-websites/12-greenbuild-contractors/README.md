...
## Description
Projects, equipment, safety, services, galleries, and contracting portfolios. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
