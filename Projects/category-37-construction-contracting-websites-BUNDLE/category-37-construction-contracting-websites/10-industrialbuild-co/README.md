...
## Description
Projects, equipment, safety, services, galleries, and contracting portfolios. This template uses a distinct UI pattern: AI assistant workspace with prompt panel and result board.
