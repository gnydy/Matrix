# ConstructionJobs Hub

Category: 43 - Job Boards & Recruitment Platforms

## Description
Job listings, applications, candidate profiles, company pages, and recruiter dashboards. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
