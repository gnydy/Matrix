...
## Description
Job listings, applications, candidate profiles, company pages, and recruiter dashboards. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
