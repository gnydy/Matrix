# HealthcareJobs Portal

Category: 43 - Job Boards & Recruitment Platforms

## Description
Job listings, applications, candidate profiles, company pages, and recruiter dashboards. This template uses a distinct UI pattern: AI assistant workspace with prompt panel and result board.
