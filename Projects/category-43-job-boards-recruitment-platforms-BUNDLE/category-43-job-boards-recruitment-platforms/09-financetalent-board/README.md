...
## Description
Job listings, applications, candidate profiles, company pages, and recruiter dashboards. This template uses a distinct UI pattern: dark operations cockpit with alert stream.
