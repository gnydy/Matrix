$root = "/mnt/data/categories-26-to-50-batch-16/category-43-job-boards-recruitment-platforms"
...
Write-Host "Started category 43 from 3001 to 3020" -ForegroundColor Green
