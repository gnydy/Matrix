export const site = {
  ...
  "templateName": "FinanceHelp Base",
  "slug": "15-financehelp-base",
  "tagline": "FinanceHelp Base is a sellable Knowledge Base Platforms template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "FinanceHelp Base record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "64%"
    },
    {
      "id": "R-002",
      "name": "FinanceHelp Base record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "76%"
    },
    {
      "id": "R-003",
      "name": "FinanceHelp Base record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "88%"
    },
    {
      "id": "R-004",
      "name": "FinanceHelp Base record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "100%"
    },
    {
      "id": "R-005",
      "name": "FinanceHelp Base record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "112%"
    },
    {
      "id": "R-006",
      "name": "FinanceHelp Base record 6",
      "owner": "QA",
      "status": "Review",
      "value": "124%"
    }
