# Enterprise Interior HQ

Category: 38 - Interior Design Websites

## Description
Rooms, moodboards, packages, before/after, and consultation booking. This template uses a distinct UI pattern: data room layout with document table and activity feed.
