...
## Description
Rooms, moodboards, packages, before/after, and consultation booking. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
