# BeforeAfter Interior

Category: 38 - Interior Design Websites

## Description
Rooms, moodboards, packages, before/after, and consultation booking. This template uses a distinct UI pattern: split command layout with sticky right insight panel.
