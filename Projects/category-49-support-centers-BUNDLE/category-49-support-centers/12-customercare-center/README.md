...
## Description
Knowledge bases, tickets, FAQs, chat support, contact forms, and status updates. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
