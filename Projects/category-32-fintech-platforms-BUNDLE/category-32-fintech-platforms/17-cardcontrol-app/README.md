...
## Description
Wallets, payments, banking UI, investment dashboards, and financial tools. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
