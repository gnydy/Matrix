    ...
    <Shell>
      <Topbar />
        ...
        <section className="px-5 py-8 lg:px-8">
          <div className="rounded-[2rem] bg-white p-5 shadow-xl"><div className="flex flex-wrap items-end justify-between gap-4 p-4"><div><p className="text-xs font-black uppercase tracking-[0.35em] text-slate-400">Project profitability board</p><h2 className="mt-3 text-4xl font-black">{site.concept}</h2></div><button className="rounded-full bg-[var(--accent)] px-5 py-3 font-black text-white">Create Workflow</button></div>
