...
Branches, POS summaries, products, stock transfers and cashier performance.

## Use Case
Frontend ERP template for Retail chains needing a credible system UI demo without building a backend yet.
