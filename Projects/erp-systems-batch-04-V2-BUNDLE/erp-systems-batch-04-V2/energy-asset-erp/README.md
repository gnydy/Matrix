...
Assets, maintenance, field readings, incidents, procurement and safety controls.

## Use Case
Frontend ERP template for Energy operators needing a credible system UI demo without building a backend yet.
