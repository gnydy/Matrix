...
Employee records, attendance, payroll cycle, leaves and performance control desk.

## Use Case
Frontend ERP template for HR and payroll operations needing a credible system UI demo without building a backend yet.
