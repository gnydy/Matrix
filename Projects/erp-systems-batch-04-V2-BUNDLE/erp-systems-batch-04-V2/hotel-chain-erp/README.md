...
Rooms, bookings, housekeeping, guest accounts and revenue operations.

## Use Case
Frontend ERP template for Hotels and hospitality groups needing a credible system UI demo without building a backend yet.
