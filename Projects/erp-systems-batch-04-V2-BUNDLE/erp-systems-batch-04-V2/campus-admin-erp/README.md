...
Admissions, classes, student fees, teachers, attendance and academic operations.

## Use Case
Frontend ERP template for Schools and universities needing a credible system UI demo without building a backend yet.
