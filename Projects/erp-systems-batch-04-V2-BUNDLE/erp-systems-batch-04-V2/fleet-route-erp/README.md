...
Fleet dispatch, route planning, shipments, driver status and delivery SLA control.

## Use Case
Frontend ERP template for Logistics and delivery companies needing a credible system UI demo without building a backend yet.
