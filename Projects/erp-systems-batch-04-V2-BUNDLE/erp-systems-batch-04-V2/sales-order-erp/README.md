...
Sales orders, quotations, invoices, client accounts and margin visibility.

## Use Case
Frontend ERP template for B2B sales operations needing a credible system UI demo without building a backend yet.
