...
Crops, irrigation, harvest batches, sensors, equipment and farm inventory.

## Use Case
Frontend ERP template for Agriculture operations needing a credible system UI demo without building a backend yet.
