...
Patient flow, departments, billing, stock, claims and resource allocation.

## Use Case
Frontend ERP template for Clinics and hospital networks needing a credible system UI demo without building a backend yet.
