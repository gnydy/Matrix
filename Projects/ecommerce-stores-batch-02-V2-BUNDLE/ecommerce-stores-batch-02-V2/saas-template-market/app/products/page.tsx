    ...
    <section className="mx-auto max-w-7xl px-5 py-12">
      <div className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr]">
        <aside className="h-fit rounded-[2rem] border border-white/10 bg-white/5 p-6">
          ...
          <div className="mt-6 rounded-2xl bg-gradient-to-r from-blue-400 to-indigo-700 p-5 text-white"><p className="text-xs font-black uppercase tracking-[0.25em]">Filter logic</p><p className="mt-2 text-sm">Mock filters are designed as UI-ready controls for real data later.</p></div>
        </aside>
