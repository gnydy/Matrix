...
Sensory perfume shop with note pyramids, mood filters, gifting flow, and premium storytelling.

## Target client
Perfume stores, oud brands, fragrance boutiques.

## UX pattern
`sensory-boutique` — this template is not a recolor. It uses a unique store structure, homepage composition, catalog style, and commerce positioning.
