...
export default function AccountPage() {
  return <main className="min-h-screen bg-slate-50 text-slate-950"><Header />
    <section className="mx-auto max-w-7xl px-5 py-12"><p className="text-sm font-black uppercase tracking-[0.25em] text-indigo-600">Customer area mock</p><h1 className="mt-3 text-5xl font-black">Account dashboard</h1>
