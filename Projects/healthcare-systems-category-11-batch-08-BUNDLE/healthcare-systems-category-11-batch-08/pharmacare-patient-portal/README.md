...
## وصف القالب
PharmaCare Patient Portal هو قالب Healthcare System UI مبني بـ Next.js وTypeScript وTailwind CSS. القالب يعطي شكل نظام طبي حقيقي لقطاع: Pharmacy and chronic care.

## Use Case
refills, medication plans, patient dashboard.

## Target Client
Pharmacy chains and chronic care programs.
