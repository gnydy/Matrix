# OncoCare Treatment Board

## وصف القالب
OncoCare Treatment Board هو قالب Healthcare System UI مبني بـ Next.js وTypeScript وTailwind CSS. القالب يعطي شكل نظام طبي حقيقي لقطاع: Oncology.

## Use Case
care pathways, sessions, lab reports mock.

## Target Client
Cancer centers and specialty hospitals.
