# CardioWatch Heart Clinic

## وصف القالب
CardioWatch Heart Clinic هو قالب Healthcare System UI مبني بـ Next.js وTypeScript وTailwind CSS. القالب يعطي شكل نظام طبي حقيقي لقطاع: Cardiology.

## Use Case
ECG mock, risk cards, appointments, follow-ups.

## Target Client
Heart clinics and cardiac centers.
