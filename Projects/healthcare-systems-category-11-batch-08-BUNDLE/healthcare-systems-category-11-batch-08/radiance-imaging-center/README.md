# Radiance Imaging Center

## وصف القالب
Radiance Imaging Center هو قالب Healthcare System UI مبني بـ Next.js وTypeScript وTailwind CSS. القالب يعطي شكل نظام طبي حقيقي لقطاع: Radiology.

## Use Case
scan schedule, reports, imaging status.
