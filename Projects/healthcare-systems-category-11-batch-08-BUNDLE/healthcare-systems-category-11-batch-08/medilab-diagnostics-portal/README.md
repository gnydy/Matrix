# MediLab Diagnostics Portal

## وصف القالب
MediLab Diagnostics Portal هو قالب Healthcare System UI مبني بـ Next.js وTypeScript وTailwind CSS. القالب يعطي شكل نظام طبي حقيقي لقطاع: Diagnostics and laboratories.

## Use Case
test orders, sample tracking, reports.

## Target Client
Labs, imaging centers, blood test providers.
