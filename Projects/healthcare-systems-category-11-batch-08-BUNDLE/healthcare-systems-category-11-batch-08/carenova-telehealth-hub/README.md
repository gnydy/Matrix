# CareNova Telehealth Hub

## وصف القالب
CareNova Telehealth Hub هو قالب Healthcare System UI مبني بـ Next.js وTypeScript وTailwind CSS. القالب يعطي شكل نظام طبي حقيقي لقطاع: Telemedicine.

## Use Case
video consults mock, remote triage, subscriptions.

## Target Client
Telehealth startups and online doctors.
