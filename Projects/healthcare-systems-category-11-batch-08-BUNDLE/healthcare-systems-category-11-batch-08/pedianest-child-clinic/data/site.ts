export const site = {
  "templateName": "PediaNest Child Clinic",
  "sector": "Pediatrics",
  "audience": "Pediatric clinics and child health centers",
  "useCase": "vaccines, growth records, appointments",
  "vibe": "friendly pediatric admin",
