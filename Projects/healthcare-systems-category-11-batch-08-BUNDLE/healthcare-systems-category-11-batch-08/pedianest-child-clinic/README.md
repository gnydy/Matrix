# PediaNest Child Clinic

## وصف القالب
PediaNest Child Clinic هو قالب Healthcare System UI مبني بـ Next.js وTypeScript وTailwind CSS. القالب يعطي شكل نظام طبي حقيقي لقطاع: Pediatrics.

## Use Case
vaccines, growth records, appointments.

## Target Client
Pediatric clinics and child health centers.
