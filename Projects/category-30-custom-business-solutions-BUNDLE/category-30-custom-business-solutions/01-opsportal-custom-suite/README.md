# OpsPortal Custom Suite

Category: 30 - Custom Business Solutions

## Description
Internal portals, operational systems, workflows, and business dashboards. This template uses a distinct UI pattern: dashboard marketplace grid with comparison cards.
