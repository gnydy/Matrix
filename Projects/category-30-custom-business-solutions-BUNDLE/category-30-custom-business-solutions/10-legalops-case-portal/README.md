# LegalOps Case Portal

Category: 30 - Custom Business Solutions

## Description
Internal portals, operational systems, workflows, and business dashboards. This template uses a distinct UI pattern: dark operations cockpit with alert stream.
