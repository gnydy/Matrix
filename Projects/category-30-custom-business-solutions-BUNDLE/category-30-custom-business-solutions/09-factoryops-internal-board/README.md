# FactoryOps Internal Board

Category: 30 - Custom Business Solutions

## Description
Internal portals, operational systems, workflows, and business dashboards. This template uses a distinct UI pattern: card-based workspace with filter bar and live status rail.
