# ClinicAdmin Custom Solution

Category: 30 - Custom Business Solutions

## Description
Internal portals, operational systems, workflows, and business dashboards. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
