$root = "/mnt/data/categories-26-to-50-batch-16/category-30-custom-business-solutions"
...
Write-Host "Started category 30 from 3001 to 3020" -ForegroundColor Green
