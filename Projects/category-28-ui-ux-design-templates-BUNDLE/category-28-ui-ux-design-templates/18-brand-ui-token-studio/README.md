# Brand UI Token Studio

Category: 28 - UI/UX Design Templates

## Description
Design systems, component libraries, wireframes, and product screens. This template uses a distinct UI pattern: data room layout with document table and activity feed.
