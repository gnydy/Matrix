# Landing Page Section Kit

Category: 28 - UI/UX Design Templates

## Description
Design systems, component libraries, wireframes, and product screens. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
