# Accessibility UI Audit Kit

Category: 28 - UI/UX Design Templates

## Description
Design systems, component libraries, wireframes, and product screens. This template uses a distinct UI pattern: desktop app shell with toolbar, tabs, and resizable panels.
