# Prototype Review Board

Category: 28 - UI/UX Design Templates

## Description
Design systems, component libraries, wireframes, and product screens. This template uses a distinct UI pattern: dashboard marketplace grid with comparison cards.
