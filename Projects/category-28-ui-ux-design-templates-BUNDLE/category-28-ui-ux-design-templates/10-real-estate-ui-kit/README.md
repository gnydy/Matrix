...
## Description
Design systems, component libraries, wireframes, and product screens. This template uses a distinct UI pattern: marketing website with editorial hero and case-study grid.
