export const site = {
  ...
  "templateName": "API Reference Hub",
  "slug": "02-api-reference-hub",
  "tagline": "API Reference Hub is a sellable Documentation Websites template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "API Reference Hub record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "63%"
    },
    {
      "id": "R-002",
      "name": "API Reference Hub record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "75%"
    },
    {
      "id": "R-003",
      "name": "API Reference Hub record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "87%"
    },
    {
      "id": "R-004",
      "name": "API Reference Hub record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "99%"
    },
    {
      "id": "R-005",
      "name": "API Reference Hub record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "111%"
    },
    {
      "id": "R-006",
      "name": "API Reference Hub record 6",
      "owner": "QA",
      "status": "Review",
      "value": "123%"
    }
