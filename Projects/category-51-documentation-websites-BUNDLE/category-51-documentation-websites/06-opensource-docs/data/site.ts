export const site = {
  ...
  "templateName": "OpenSource Docs",
  "slug": "06-opensource-docs",
  "tagline": "OpenSource Docs is a sellable Documentation Websites template with realistic modules and backend mock routes.",
