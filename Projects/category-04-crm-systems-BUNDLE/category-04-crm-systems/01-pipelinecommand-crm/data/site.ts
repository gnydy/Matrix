export const site = {
  ...
  "templateName": "PipelineCommand CRM",
  "slug": "01-pipelinecommand-crm",
  "tagline": "PipelineCommand CRM is a sellable CRM Systems template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "PipelineCommand CRM record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "16%"
    },
    {
      "id": "R-002",
      "name": "PipelineCommand CRM record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "28%"
    },
    {
      "id": "R-003",
      "name": "PipelineCommand CRM record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "40%"
    },
    {
      "id": "R-004",
      "name": "PipelineCommand CRM record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "52%"
    },
    {
      "id": "R-005",
      "name": "PipelineCommand CRM record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "64%"
    },
    {
      "id": "R-006",
      "name": "PipelineCommand CRM record 6",
      "owner": "QA",
      "status": "Review",
      "value": "76%"
    }
