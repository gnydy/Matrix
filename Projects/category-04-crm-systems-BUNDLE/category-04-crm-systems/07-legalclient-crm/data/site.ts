export const site = {
  ...
  "templateName": "LegalClient CRM",
  "slug": "07-legalclient-crm",
  "tagline": "LegalClient CRM is a sellable CRM Systems template with realistic modules and backend mock routes.",
