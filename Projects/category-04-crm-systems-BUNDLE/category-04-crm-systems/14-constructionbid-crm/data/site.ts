export const site = {
  ...
  "templateName": "ConstructionBid CRM",
  "slug": "14-constructionbid-crm",
  "tagline": "ConstructionBid CRM is a sellable CRM Systems template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "ConstructionBid CRM record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "16%"
    },
    {
      "id": "R-002",
      "name": "ConstructionBid CRM record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "28%"
    },
    {
      "id": "R-003",
      "name": "ConstructionBid CRM record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "40%"
    },
    {
      "id": "R-004",
      "name": "ConstructionBid CRM record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "52%"
    },
    {
      "id": "R-005",
      "name": "ConstructionBid CRM record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "64%"
    },
    {
      "id": "R-006",
      "name": "ConstructionBid CRM record 6",
      "owner": "QA",
      "status": "Review",
      "value": "76%"
    }
