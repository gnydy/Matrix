...
## Description
Workflow automation, approvals, triggers, actions, and process orchestration. This template uses a distinct UI pattern: split command layout with sticky right insight panel.
