# Finance Approval Ladder

Category: 26 - Automation Systems

## Description
Workflow automation, approvals, triggers, actions, and process orchestration. This template uses a distinct UI pattern: dashboard marketplace grid with comparison cards.
