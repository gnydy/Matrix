# Marketing Campaign Autopilot

Category: 26 - Automation Systems

## Description
Workflow automation, approvals, triggers, actions, and process orchestration. This template uses a distinct UI pattern: timeline-first workflow interface.
