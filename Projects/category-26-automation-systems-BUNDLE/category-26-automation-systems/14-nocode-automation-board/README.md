# NoCode Automation Board

Category: 26 - Automation Systems

## Description
Workflow automation, approvals, triggers, actions, and process orchestration. This template uses a distinct UI pattern: dark operations cockpit with alert stream.
