# Procurement Flow Center

Category: 26 - Automation Systems

## Description
Workflow automation, approvals, triggers, actions, and process orchestration. This template uses a distinct UI pattern: card-based workspace with filter bar and live status rail.
