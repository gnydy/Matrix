...
## Description
Workflow automation, approvals, triggers, actions, and process orchestration. This template uses a distinct UI pattern: marketing website with editorial hero and case-study grid.
