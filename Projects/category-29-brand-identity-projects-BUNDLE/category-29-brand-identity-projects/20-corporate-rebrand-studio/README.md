# Corporate Rebrand Studio

Category: 29 - Brand Identity Projects

## Description
Brand guidelines, logo systems, typography, colors, and case studies. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
