# Construction Brand Guide

Category: 29 - Brand Identity Projects

## Description
Brand guidelines, logo systems, typography, colors, and case studies. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
