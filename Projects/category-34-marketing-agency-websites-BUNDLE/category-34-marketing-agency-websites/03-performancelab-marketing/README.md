# PerformanceLab Marketing

Category: 34 - Marketing Agency Websites

## Description
Campaigns, growth services, case studies, pricing, and client success. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
