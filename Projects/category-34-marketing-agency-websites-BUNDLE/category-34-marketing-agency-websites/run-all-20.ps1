$root = "/mnt/data/categories-26-to-50-batch-16/category-34-marketing-agency-websites"
...
Write-Host "Started category 34 from 3001 to 3020" -ForegroundColor Green
