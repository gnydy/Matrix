# Enterprise Growth HQ

Category: 34 - Marketing Agency Websites

## Description
Campaigns, growth services, case studies, pricing, and client success. This template uses a distinct UI pattern: desktop app shell with toolbar, tabs, and resizable panels.
