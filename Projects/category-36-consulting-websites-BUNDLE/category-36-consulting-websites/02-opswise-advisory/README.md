...
## Description
Business strategy, finance, HR, operations, and transformation consulting. This template uses a distinct UI pattern: marketing website with editorial hero and case-study grid.
