# HealthcareClient Reports

Category: 48 - Client Dashboards

## Description
KPIs, reports, services, payments, progress, support, and notifications. This template uses a distinct UI pattern: AI assistant workspace with prompt panel and result board.
