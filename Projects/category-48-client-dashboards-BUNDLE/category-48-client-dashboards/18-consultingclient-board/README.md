# ConsultingClient Board

Category: 48 - Client Dashboards

## Description
KPIs, reports, services, payments, progress, support, and notifications. This template uses a distinct UI pattern: desktop app shell with toolbar, tabs, and resizable panels.
