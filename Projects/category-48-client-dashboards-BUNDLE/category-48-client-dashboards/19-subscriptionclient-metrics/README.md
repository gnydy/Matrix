# SubscriptionClient Metrics

Category: 48 - Client Dashboards

## Description
KPIs, reports, services, payments, progress, support, and notifications. This template uses a distinct UI pattern: dashboard marketplace grid with comparison cards.
