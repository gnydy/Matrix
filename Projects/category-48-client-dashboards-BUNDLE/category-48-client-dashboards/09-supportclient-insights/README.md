# SupportClient Insights

Category: 48 - Client Dashboards

## Description
KPIs, reports, services, payments, progress, support, and notifications. This template uses a distinct UI pattern: minimal luxury website with oversized typography.
