# ContractReview Portal

Category: 33 - Legal & Law Firm Websites

## Description
Law firm sites, consultation booking, legal articles, cases, and teams. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
