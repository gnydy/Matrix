...
## Description
Law firm sites, consultation booking, legal articles, cases, and teams. This template uses a distinct UI pattern: desktop app shell with toolbar, tabs, and resizable panels.
