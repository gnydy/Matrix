# CounselDesk Consultation

Category: 33 - Legal & Law Firm Websites

## Description
Law firm sites, consultation booking, legal articles, cases, and teams. This template uses a distinct UI pattern: split command layout with sticky right insight panel.
