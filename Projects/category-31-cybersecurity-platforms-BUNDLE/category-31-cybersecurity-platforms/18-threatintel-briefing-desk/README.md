# ThreatIntel Briefing Desk

Category: 31 - Cybersecurity Platforms

## Description
SOC dashboards, threat monitoring, compliance, and security services. This template uses a distinct UI pattern: dense admin console with left rail and KPI ribbon.
