# EndpointWatch Console

Category: 31 - Cybersecurity Platforms

## Description
SOC dashboards, threat monitoring, compliance, and security services. This template uses a distinct UI pattern: desktop app shell with toolbar, tabs, and resizable panels.
