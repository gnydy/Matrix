# SecurityAwareness LMS

Category: 31 - Cybersecurity Platforms

## Description
SOC dashboards, threat monitoring, compliance, and security services. This template uses a distinct UI pattern: dashboard marketplace grid with comparison cards.
