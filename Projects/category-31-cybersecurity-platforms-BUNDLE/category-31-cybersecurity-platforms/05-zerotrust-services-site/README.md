# ZeroTrust Services Site

Category: 31 - Cybersecurity Platforms

## Description
SOC dashboards, threat monitoring, compliance, and security services. This template uses a distinct UI pattern: split command layout with sticky right insight panel.
