...
## Description
Forums, groups, posts, members, moderation, and community dashboards. This template uses a distinct UI pattern: dashboard marketplace grid with comparison cards.
