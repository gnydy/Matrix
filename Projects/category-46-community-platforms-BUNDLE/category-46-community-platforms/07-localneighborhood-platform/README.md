# LocalNeighborhood Platform

Category: 46 - Community Platforms

## Description
Forums, groups, posts, members, moderation, and community dashboards. This template uses a distinct UI pattern: mobile-first stacked panels with bottom action bar.
