# AlumniCommunity Portal

Category: 46 - Community Platforms

## Description
Forums, groups, posts, members, moderation, and community dashboards. This template uses a distinct UI pattern: split command layout with sticky right insight panel.
