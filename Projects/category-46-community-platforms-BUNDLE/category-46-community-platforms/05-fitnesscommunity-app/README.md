# FitnessCommunity App

Category: 46 - Community Platforms

## Description
Forums, groups, posts, members, moderation, and community dashboards. This template uses a distinct UI pattern: card-based workspace with filter bar and live status rail.
