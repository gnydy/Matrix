# WomenBusiness Network

Category: 46 - Community Platforms

## Description
Forums, groups, posts, members, moderation, and community dashboards. This template uses a distinct UI pattern: AI assistant workspace with prompt panel and result board.
