...
Teacher-first classroom operations platform

## Commercial Description
A polished education platform frontend for schools, academies, and independent teachers. It includes LMS-style pages, student dashboard, teacher dashboard, progress tracking, admin operations, mock data, and commercial UI sections.

## Use Case
Give teachers planning, materials, student lists, attendance, and assessment UI.

## Target Client
Schools, academies, and independent teachers
