# CourseMarket Creator

Marketplace-style course storefront

## Commercial Description
A polished education platform frontend for course creators and education startups. It includes LMS-style pages, student dashboard, teacher dashboard, progress tracking, admin operations, mock data, and commercial UI sections.

## Use Case
Sell multiple courses with instructor pages, ratings, bundles, and learner accounts.

## Target Client
Course creators and education startups
