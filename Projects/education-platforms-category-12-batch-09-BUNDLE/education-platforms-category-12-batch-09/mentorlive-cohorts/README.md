...
Live cohort-based learning platform

## Commercial Description
A polished education platform frontend for premium coaches, accelerators, and community academies. It includes LMS-style pages, student dashboard, teacher dashboard, progress tracking, admin operations, mock data, and commercial UI sections.

## Use Case
Run cohorts with sessions, mentors, assignment reviews, community prompts, and progress.

## Target Client
Premium coaches, accelerators, and community academies
