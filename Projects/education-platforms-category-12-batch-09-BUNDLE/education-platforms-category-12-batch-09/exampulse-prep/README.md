...
A polished education platform frontend for test-prep centers and online exam coaches. It includes LMS-style pages, student dashboard, teacher dashboard, progress tracking, admin operations, mock data, and commercial UI sections.

## Use Case
Organize question banks, mock exams, revision schedules, and performance analytics.

## Target Client
Test-prep centers and online exam coaches
