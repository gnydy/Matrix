# MicroLearn Mobile LMS

Microlearning platform optimized for short lessons

## Commercial Description
A polished education platform frontend for training startups and mobile-first education brands. It includes LMS-style pages, student dashboard, teacher dashboard, progress tracking, admin operations, mock data, and commercial UI sections.

## Use Case
Show bite-sized lessons, streaks, learning nudges, and progress cards.

## Target Client
Training startups and mobile-first education brands
