...
A polished education platform frontend for coding academies, bootcamps, and freelance instructors. It includes LMS-style pages, student dashboard, teacher dashboard, progress tracking, admin operations, mock data, and commercial UI sections.

## Use Case
Sell cohorts, manage coding tracks, show assignments, and track practical projects.

## Target Client
Coding academies, bootcamps, and freelance instructors
