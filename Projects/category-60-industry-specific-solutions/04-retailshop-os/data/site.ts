export const site = {
  ...
  "templateName": "RetailShop OS",
  "slug": "04-retailshop-os",
  "tagline": "RetailShop OS is a sellable Industry-Specific Solutions template with realistic modules and backend mock routes.",
