export const site = {
  ...
  "templateName": "LogisticsCommand Suite",
  "slug": "06-logisticscommand-suite",
  "tagline": "LogisticsCommand Suite is a sellable Industry-Specific Solutions template with realistic modules and backend mock routes.",
  ...
  "records": [
    {
      "id": "R-001",
      "name": "LogisticsCommand Suite record 1",
      "owner": "Operations",
      "status": "Active",
      "value": "72%"
    },
    {
      "id": "R-002",
      "name": "LogisticsCommand Suite record 2",
      "owner": "Finance",
      "status": "Pending",
      "value": "84%"
    },
    {
      "id": "R-003",
      "name": "LogisticsCommand Suite record 3",
      "owner": "Sales",
      "status": "At Risk",
      "value": "96%"
    },
    {
      "id": "R-004",
      "name": "LogisticsCommand Suite record 4",
      "owner": "Support",
      "status": "Approved",
      "value": "108%"
    },
    {
      "id": "R-005",
      "name": "LogisticsCommand Suite record 5",
      "owner": "Admin",
      "status": "Draft",
      "value": "120%"
    },
    {
      "id": "R-006",
      "name": "LogisticsCommand Suite record 6",
      "owner": "QA",
      "status": "Review",
      "value": "132%"
    }
